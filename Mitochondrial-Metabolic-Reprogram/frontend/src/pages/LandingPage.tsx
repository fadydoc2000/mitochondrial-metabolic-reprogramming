          ...
          <div>
            <div className="gauge" role="img" aria-label="Glucose-Ketone Index metabolic zones: green under 1.0, yellow 1.0 to 3.0, red over 3.0">
              ...
              <div className="gauge-core">
                ...
                <div className="zone">Therapeutic</div>
              </div>
            </div>
        ...
        <div className="wrap">
          ...
          <div className="stats">
            <div className="stat">
              ...
              <div className="src">Seyfried et al., small GBM study (n=18)</div>
            </div>
            <div className="stat">
              ...
              <div className="src">33% of trial participants held adherence</div>
            </div>
            <div className="stat">
              ...
              <div className="src">Glucose-Ketone Index, 2025–2026</div>
            </div>
          </div>
          ...
          <div className="cites">
            <span className="cite">Seyfried et al. (2025) · Mitochondrial Metabolic Theory of Cancer, J. Bioenerg. Biomembr.</span>
            <span className="cite">Duraj et al. (2024) · Ketogenic metabolic therapy framework in glioblastoma, BMC Medicine</span>
            <span className="cite">Glucose-Ketone Index research (2026) · Frontiers in Science</span>
          </div>
        </div>
      </section>
